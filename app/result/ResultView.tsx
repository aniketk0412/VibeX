...
// Output view — in-browser code (mock files for now), the prompt history, and a download.
// When opened from a saved project, `spec` and `history` are real (from the DB); otherwise it
// falls back to the sessionStorage spec and a sample history.
...
export default function ResultView({ spec: specProp, history: historyProp }: { spec?: Spec; history?: HistoryRow[] }) {
  ...
  const history = historyProp && historyProp.length ? historyProp : MOCK_HISTORY;
